	...
	public class AHA {
		...
		private void traitement(Arbre q) {
			...
			while (p.pere != null) {
				p.poids++;
				/*
				 * Apres l'incrementation , on remonte dans l'odre GDBH pour controler
				 */
		...
		/**
		 * MAJ de la list ordonée des noeuds
		 * On met a jour la liste grace a un parcourt en largeur de l'arbre
		 */
